...
def get_git_metrics(interval="weekly"):
    ...
    # Include both author name and author email
    git_args = [
        'git', 'log', '--no-merges',
    ...
    for line in raw_output.strip().split('\n'):
        ...
        if line.startswith('COMMIT|||'):
            ...
            # ---------------------------------------------------------
            # Use email as the identity for Sanjeevani.
            # This combines:
            # Sanjeevani Sharma
            # Sanjeevani-Sharma
            # because both use the same email.
            # ---------------------------------------------------------
            if email == "sanjeevanisharma0811@gmail.com":
                current_author = "Sanjeevani Sharma"
            else:
            ...
            if len(parts) >= 3 and parts[0].isdigit() and parts[1].isdigit():
                ...
                # Ignore dependency files from LOC calculation
